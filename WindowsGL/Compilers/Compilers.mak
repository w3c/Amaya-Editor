...
CPP=cl.exe
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\thotlib\include" /I "..\..\thotlib\internals\f" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "__STDC__" /D "_WINDOWS_COMPILERS" /D "_I18N_" /D "_GL" /Fp"$(INTDIR)\Compilers.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
CPP=cl.exe
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /I "..\..\thotlib\include" /I "..\..\thotlib\internals\f" /D "__STDC__" /D "_WINDOWS_COMPILERS" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_GL" /D "_I18N_" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\Compilers.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"LibThotKernel - Win32 Release" : 
   cd "\cvs\Amaya\WindowsGL\LibThotKernel"
...
"$(INTDIR)\Compilers.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x40c /fo"$(INTDIR)\Compilers.res" /i "\cvs\Amaya\batch" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\Compilers.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x40c /fo"$(INTDIR)\Compilers.res" /i "\cvs\Amaya\batch" /d "_DEBUG" $(SOURCE)
