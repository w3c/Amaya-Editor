...
#define NumMenuReducedFormat 	55
#define NumZoneFirstPage 	56
#define NumZoneLastPage 	57
#define NumZoneNbOfCopies 	58
#define NumZonePrinterName 	59
#define NumLabelStarPrintView 60
