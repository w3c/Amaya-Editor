...
#define NbLtr     120  /* maximum number of letters in the alphabet  < 256 isolatin1  */

typedef char    FileName[MAX_NAME_LENGTH];    /* filename */

typedef  char *PtrChaine;   /* pointer to the word list */
typedef  char *PtrCommuns;  /* pointer to the list of common letters */
...
typedef struct _Dictionnaire
{
      ...
      Language    DictLangue;               /* the language of the dictionary */
       int MAXcars;       /* max characters for string and for common */
      ...
      int         nbcars;     /* number of characters in a string */
