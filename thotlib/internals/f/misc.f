...
extern void xpmSetAttributes ( XpmAttributes *attributes, XpmImage *image, XpmInfo *info );
...
extern void xpmCreatePixmapFromImage ( Display *display, Drawable d, XImage *ximage, Pixmap *pixmap_return );
extern void xpmCreateImageFromPixmap ( Display *display, Pixmap pixmap, XImage **ximage_return, unsigned int *width, unsigned int *height );
