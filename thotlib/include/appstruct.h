...
extern void         TteOpenMainWindow (CHAR_T* name, Pixmap logo, Pixmap icon);
extern void         TteInitMenus (CHAR_T* name, int number);
...
extern void         TtcInsertChar (Document document, View view, UCHAR_T c);
extern void         TtcInsertGraph (Document document, View view, UCHAR_T c);
