...
extern void       CreateAltDlgWindow (int, int, int, int, CHAR_T*, CHAR_T*);
extern void       CreateCSSDlgWindow (HWND, int, int, int, STRING, int, STRING, STRING, CHAR_T*);
extern void       CreateTextDlgWindow (HWND, STRING, int, int, int, CHAR_T*, CHAR_T*);
...
extern void       CreateOpenDocDlgWindow (HWND, STRING, STRING, int, int, int, int, int, int);
