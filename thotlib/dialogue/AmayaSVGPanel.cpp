...
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_FLIP_VERTICALLY",       "TransformSVG_FlipVertically", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_FLIP_HORIZONTALLY",       "TransformSVG_FlipHorizontally", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_BRING_TO_FRONT",       "TransformSVG_BringToFront", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_BRING_FORWARD",       "TransformSVG_BringForward", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_SEND_BACKWARD",       "TransformSVG_SendBackward", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_SEND_TO_BACK",       "TransformSVG_SendToBack", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_ROTATE_ANTICLOCKWISE",       "TransformSVG_AntiClockWise", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_ROTATE_CLOCKWISE",       "TransformSVG_ClockWise", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_ALIGN_LEFT",       "TransformSVG_AlignLeft", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_ALIGN_CENTER",       "TransformSVG_AlignCenter", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_ALIGN_RIGHT",       "TransformSVG_AlignRight", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_ALIGN_BOTTOM",       "TransformSVG_AlignBottom", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_ALIGN_MIDDLE",       "TransformSVG_AlignMiddle", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_ALIGN_TOP",       "TransformSVG_AlignTop", wxID_ANY, wxID_ANY)
AMAYA_TOOLBAR_DEF("wxID_PANEL_SVG_ROTATE",       "TransformSVG_Rotate", wxID_ANY, wxID_ANY)
