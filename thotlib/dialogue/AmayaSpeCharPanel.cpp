...
AmayaSpeChar filtre_fleches[] =
  {
    ...
    {0x21E0, "leftwards dashed"},
    {0x21E1, "upwards dashed"},
    {0x21E2, "rightwards dashed"},
    {0x21E3, "downwards dashed"},
    {0x21E4, "leftwards to bar"},
    {0x21E5, "rightwards to bar"},
    {0x21E6, "leftwards white"},
    {0x21E7, "upwards white"},
    {0x21E8, "rightwards white"},
    {0x21E9, "downwards white"},
    {0x21EA, "upwards white from bar"},
    {0x21EB, "upwards white on pedestal"},
    {0x21EC, "upwards white on pedestal with horizontal bar"},
    {0x21ED, "upwards white on pedestal with vertical bar"},
    {0x21EE, "upward white double"},
    {0x21EF, "upward white double on pedestal"},
    {0x21F0, "rightwards white from wall"},
    {0x21F1, "north west  to corner"},
    {0x21F2, "south east to corner"},
    {0x21F3, "up down white"},
    {0x21F4, "right with small circle"},
    {0x21F5, "downwards arrow leftwards of upwards arrow"},
    {0x21F6, "three rightwards"},
    {0x21F7, "leftwards with vertical stroke"},
    {0x21F8, "rightwards with vertical stroke"},
    {0x21F9, "left right with vertical stroke"},
    {0x21FA, "leftwards with double vertical stroke"},
    {0x21FB, "rightwards with double vertical stroke"},
    {0x21FC, "left right with double vertical stroke"},
    {0x21FD, "leftwards open-headed"},
    {0x21FE, "rightwards open-headed"},
    {0x21FF, "left right open-headed"},
    {-1, ""}
  };
