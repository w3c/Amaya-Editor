	  ...
	  if (pChildAb->AbFloat != 'N' &&
	      ...
	      if (pInc)
		{
		  if (pInc->AbFloat != 'N' &&
		    ...
		    {
		      found = HasFloatingChild (pInc, directParent, &unique);
	  ...
	  if (pAb->AbLeafType == LtCompound)
	      ...
	      else
		{
	      ...
	      if ((inLine || /* within a block */
		   (inLineFloat && /* within a block generated by floated boxes */
		    (inlineFloatC /* parent of a float */ ||
		    /* skip only one level within block generated by floated boxes */
		     pAb->AbEnclosing &&
...
ThotBool ComputeUpdates (PtrAbstractBox pAb, int frame)
{
  ...
  if (pParent && pParent->AbBox)
      ...
      if (pParent->AbBox->BxType == BoBlock)
	{
      ...
      else if (pParent->AbBox->BxType == BoFloatBlock)
	{
  ...
  if (pAb->AbNew)
	   ...
	   pParent->AbEnclosing->AbBox->BxType == BoFloatGhost))
	{
	  ...
	  if (inLine || /* within a block */
	      /* skip only one level within block generated by floated boxes */
	      (inLineFloat && pParent->AbEnclosing &&
	       pParent->AbEnclosing->AbBox->BxType != BoGhost))
	    {
		  ...
		  !HasFloatingChild (pParent, &directParent, &uniqueChild) ||
		  uniqueChild)
		{
