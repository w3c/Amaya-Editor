...
static PtrBox CreateBox (PtrAbstractBox pAb, int frame, ThotBool inLine,
                         ...
                         int incfloat, PtrAbstractBox topCreation)
{
  PtrSSchema          pSS;
  ...
  if (pBox)
    {
          ...
          while (pChildAb)
            {
              box = CreateBox (pChildAb, frame, inlineChildren,
                                inlineFloatC, carIndex, incfloat, topCreation);
              pChildAb = pChildAb->AbNext;
            }
      ...
      i = 0;
      positioning = ComputePositioning (pBox, frame, topCreation);
      ...
      if (pAb->AbNew)
        {
          ...
          pBox = CreateBox (pAb, frame, inLine, inLineFloat, &i, incfloat, pAb);
