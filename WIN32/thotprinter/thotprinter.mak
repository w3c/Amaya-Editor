...
ALL : "..\bin\thotprinter.dll"

!ELSE 

ALL : "printlib - Win32 Release" "libThotTable - Win32 Release" "..\bin\thotprinter.dll"
...
!ENDIF 
	...
	-@erase "..\bin\thotprinter.dll"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /MT /W3 /GX /O2 /I "..\amaya" /I "..\..\amaya" /I "..\..\amaya\f" /I "..\..\..\libwww\Library\src" /I "..\..\tablelib\f" /I "..\..\thotlib\internals\h" /I "..\..\thotlib\internals\f" /I "..\..\thotlib\internals\var" /I "..\..\thotlib\include" /D "NDEBUG" /D "_WINDOWS" /D "__STDC__" /D "_WIN_PRINT" /D "PAGINEETIMPRIME" /D "STDC_HEADERS" /D "_MBCS" /D "WIN32" /D "_USRDLL" /D "THOTPRINTER_EXPORTS" /Fp"$(INTDIR)\thotprinter.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\thotprinter.pdb" /machine:I386 /out:"..\bin/thotprinter.dll" /implib:"$(OUTDIR)\thotprinter.lib" 
LINK32_OBJS= \
...
"..\bin\thotprinter.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "printlib - Win32 Debug" "libThotTable - Win32 Debug" "..\bin\thotprinter.dll"
...
!ENDIF 
	...
	-@erase "..\bin\thotprinter.dll"
	-@erase "..\bin\thotprinter.ilk"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\amaya" /I "..\..\amaya" /I "..\..\amaya\f" /I "..\..\..\libwww\Library\src" /I "..\..\tablelib\f" /I "..\..\thotlib\internals\h" /I "..\..\thotlib\internals\f" /I "..\..\thotlib\internals\var" /I "..\..\thotlib\include" /D "_DEBUG" /D "_WINDOWS" /D "__STDC__" /D "_WIN_PRINT" /D "PAGINEETIMPRIME" /D "STDC_HEADERS" /D "_MBCS" /D "WIN32" /D "_USRDLL" /D "THOTPRINTER_EXPORTS" /Fp"$(INTDIR)\thotprinter.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ  /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\thotprinter.pdb" /debug /machine:I386 /out:"..\bin/thotprinter.dll" /implib:"$(OUTDIR)\thotprinter.lib" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\fetchXMLname.obj" \
	"$(INTDIR)\fetchHTMLname.obj" \
	"$(INTDIR)\css.obj" \
...
"libThotTable - Win32 Release" : 
   cd "\users\guetari\Amaya\WINNT\libThotTable"
...
"printlib - Win32 Release" : 
   cd "\users\guetari\Amaya\WINNT\printlib"
