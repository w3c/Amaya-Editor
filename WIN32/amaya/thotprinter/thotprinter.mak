...
ALL : "libThotTable - Win32 Release" "printlib - Win32 Release" "$(OUTDIR)\thotprinter.dll"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"printlib - Win32 ReleaseCLEAN" "libThotTable - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I "..\\" /I "..\..\..\amaya\f" /I "..\..\..\..\libwww\Library\src" /I "..\..\..\tablelib\f" /I "..\..\..\thotlib\internals\h" /I "..\..\..\thotlib\internals\f" /I "..\..\..\thotlib\internals\var" /I "..\..\..\thotlib\include" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "THOTPRINTER_EXPORTS" /D "__STDC__" /D "_WIN_PRINT" /D "PAGINEETIMPRIME" /D "STDC_HEADERS" /Fp"$(INTDIR)\thotprinter.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\thotprinter.pdb" /machine:I386 /out:"$(OUTDIR)\thotprinter.dll" /implib:"$(OUTDIR)\thotprinter.lib" 
LINK32_OBJS= \
	"$(INTDIR)\css.obj" \
...
ALL : "libThotTable - Win32 Debug" "printlib - Win32 Debug" "$(OUTDIR)\thotprinter.dll"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"printlib - Win32 DebugCLEAN" "libThotTable - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\css.obj"
...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\\" /I "..\..\..\amaya\f" /I "..\..\..\..\libwww\Library\src" /I "..\..\..\tablelib\f" /I "..\..\..\thotlib\internals\h" /I "..\..\..\thotlib\internals\f" /I "..\..\..\thotlib\internals\var" /I "..\..\..\thotlib\include" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "THOTPRINTER_EXPORTS" /D "__STDC__" /D "_WIN_PRINT" /D "PAGINEETIMPRIME" /D "STDC_HEADERS" /Fp"$(INTDIR)\thotprinter.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /incremental:yes /pdb:"$(OUTDIR)\thotprinter.pdb" /debug /machine:I386 /out:"$(OUTDIR)\thotprinter.dll" /implib:"$(OUTDIR)\thotprinter.lib" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\css.obj" \
	"$(INTDIR)\fetchHTMLname.obj" \
	"$(INTDIR)\fetchXMLname.obj" \
...
"printlib - Win32 Release" : 
   cd "\users\guetari\Amaya\WIN32\amaya\printlib"
...
"libThotTable - Win32 Release" : 
   cd "\users\guetari\Amaya\WIN32\amaya\libThotTable"
