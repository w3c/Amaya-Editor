...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\thotlib\internals\h" /I "..\thotlib\internals\var" /I ".\amaya" /I "..\amaya" /I "..\amaya\f" /I "..\thotlib\include" /I "..\..\libwww\Library\src" /I "..\libpng\zlib" /I "..\thotlib\internals\f" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__STDC__" /D "WWW_WIN_ASYNC" /D "WWW_WIN_DLL" /D "SOCKS" /D "MATHML" /D "THOT_TOOLTIPS" /D "GRAPHML" /Fp"$(INTDIR)\amaya.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=user32.lib gdi32.lib comctl32.lib advapi32.lib wsock32.lib comdlg32.lib shell32.lib winspool.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\amaya.pdb" /machine:I386 /out:"$(OUTDIR)\amaya.exe" 
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /I ".\\" /I "..\..\thotlib\internals\h" /I "..\..\thotlib\internals\var" /I "..\..\amaya" /I "..\..\amaya\f" /I "..\..\thotlib\include" /I "..\..\..\libwww\Library\src" /I "..\..\libpng\zlib" /I "..\..\thotlib\internals\f" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "__STDC__" /D "WWW_WIN_ASYNC" /D "WWW_WIN_DLL" /D "SOCKS" /D "MATHML" /D "THOT_TOOLTIPS" /D "GRAPHML" /Fp"$(INTDIR)\amaya.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
LINK32=link.exe
LINK32_FLAGS=user32.lib gdi32.lib comctl32.lib advapi32.lib wsock32.lib comdlg32.lib shell32.lib winspool.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\amaya.pdb" /debug /machine:I386 /out:"$(OUTDIR)\amaya.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\AHTBridge.obj" \
	"$(INTDIR)\AHTFWrite.obj" \
	"$(INTDIR)\AHTMemConv.obj" \
