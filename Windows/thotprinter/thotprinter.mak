...
ALL : "libjpeg - Win32 Release" "libpng - Win32 Release"\
 "libThotTable - Win32 Release" "printlib - Win32 Release"\
...
CLEAN :"printlib - Win32 ReleaseCLEAN" "libThotTable - Win32 ReleaseCLEAN"\
 "libpng - Win32 ReleaseCLEAN" "libjpeg - Win32 ReleaseCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\initpses.obj"
	-@erase "$(INTDIR)\nodialog.obj"
...
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I "..\..\thotlib\include" /I\
 ...
 "..\..\thotlib\internals\var" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D\
...
ALL : "libjpeg - Win32 Debug" "libpng - Win32 Debug"\
 "libThotTable - Win32 Debug" "printlib - Win32 Debug"\
 "$(OUTDIR)\thotprinter.dll"
...
CLEAN :"printlib - Win32 DebugCLEAN" "libThotTable - Win32 DebugCLEAN"\
 "libpng - Win32 DebugCLEAN" "libjpeg - Win32 DebugCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\initpses.obj"
...
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /I "..\..\thotlib\include" /I\
 "..\..\thotlib\internals\h" /I "..\..\thotlib\internals\f" /I\
 "..\..\thotlib\internals\var" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D\
 "__STDC__" /D "_WIN_PRINT" /D "PAGINEETIMPRIME" /D "STDC_HEADERS" /D\
 "AMAYA_DEBUG" /Fp"$(INTDIR)\thotprinter.pch" /YX /Fo"$(INTDIR)\\"\
 /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)\thotprinter.pdb" /debug /machine:I386\
...
"$(INTDIR)\initpses.obj" : $(SOURCE) $(DEP_CPP_INITP) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
