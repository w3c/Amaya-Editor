...
# ADD CPP /nologo /W3 /GX /O2 /I "..\..\thotlib\include" /I "..\..\thotlib\internals\f" /D "NDEBUG" /D "__STDC__" /D "_WINDOWS_COMPILERS" /D "WIN32" /D "_WINDOWS" /D "_WINGUI" /D "NODISPLAY" /YX /FD /c
...
# ADD LINK32 comctl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /machine:I386 /nodefaultlib:"libc.lib"
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I "..\..\thotlib\include" /I "..\..\thotlib\internals\f" /D "_DEBUG" /D "__STDC__" /D "_WINDOWS_COMPILERS" /D "WIN32" /D "_WINDOWS" /D "_WINGUI" /D "NODISPLAY" /FR /YX /FD /c
...
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=echo "Before Compilers.exe"	..\bin\Compilers.exe	echo "After Compilers.exe"
# End Special Build Tool
