...
SOURCE="$(InputPath)"
PostBuild_Cmds=echo " Before running Compilers.exe"	..\bin\Compiliers.exe	echo "After running Compilers.exe"
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I "..\..\thotlib\include" /I "..\..\thotlib\internals\f" /D "__STDC__" /D "_WINDOWS_COMPILERS" /D "_I18N_" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /FR /YX /FD /c
