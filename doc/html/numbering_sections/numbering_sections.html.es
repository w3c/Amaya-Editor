...
<table border="0" width="100%" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p align="right"><a href="../Numbering.html.es" accesskey="t"><img
...
<p>Al <a href="../Printing.html.es">imprimir</a> el documento, la numeración
de las secciones se imprime solamente si la función está activada en ese
momento.</p>

<p>Al guardar el documento, la numeración de secciones no se guarda si se
guarda <a href="../Publishing.html.es">como HTML</a>, pero sí si se guarda <a
href="../Publishing.html.es">como texto</a>.</p>

<p>El comando de menú <strong>Editar&gt;Numeración de sección</strong> te
