...
cambios que realices se muestran únicamente en la ventana activa. Cuando
haces clic en un botón de la barra, en un comando de menú o en otro lugar,
Amaya actualiza el resto de vistas para mostrar los cambios.</p>

<p>Los comandos de selección y edición se realizan siempre en el árbol del
documento. Cuando eliges dos documentos en una vista, la selección se
extiende al sub-árbol mínimo que incluye a ambos elementos, aunque algunos
...
<ul>
  <li><a href="working_with_document_views.html.es">Utilizar las Vistas de
    Documento</a></li>
