...
<table border="0" width="100%" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p align="right"><a href="creating_an_internal_link.html.es"
        accesskey="p"><img alt="anterior" src="../../images/left.gif" /></a>
        <a href="../Links.html.es" accesskey="t"><img alt="superior"
        src="../../images/up.gif" /></a> <a
        href="removing_a_link_or_a_target_anchor.html.es"><img
  ...
  <li>Para modificar el destino, haz una de estas dos cosas: 
    ...
    <ul>
      ...
      <li>Si el documento destino no se muestra en otra ventana de Amaya,
        ...
        clic en <strong>Confirmar</strong> para crear el enlace. 
        <p></p>
      </li>
    </ul>
    <p class="ProcedureNote"><strong>Nota:</strong> También puedes editar
    manualmente el atributo <code>HREF</code> del ancla en la vista
    Estructura, o utilizar el menú <strong>Atributos</strong> de la vista
    Enlaces.</p>
  </li>
</ol>
</div>
