...
<p>Un destino es una porción de texto a la que apunta un enlace. Antes de
crear un enlace a una cadena de texto, primero tienes que crear el
destino.</p>
...
<ol>
  ...
  <li>Cuando se crea un destino, Amaya genera automáticamente un atributo
    ...
    <p>En ambos casos Amaya comprueba que los valores generados son únicos en
    el documento.</p>
  </li>
</ol>
</div>
