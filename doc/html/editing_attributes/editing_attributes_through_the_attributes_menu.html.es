...
<table border="0" width="100%" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p align="right"><a href="working_with_attributes.html.es"
        accesskey="p"><img alt="anterior" src="../../images/left.gif" /></a>
        <a href="../Attributes.html.es" accesskey="t"><img alt="superior"
...
<ol>
  <li>Selecciona el elemento completo con el ratón o pulsando
    <kbd>Escape</kbd> (en Unix) o <kbd>F2</kbd> (en Windows).
