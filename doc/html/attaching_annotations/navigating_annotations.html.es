...
<head>
  ...
  <title>Navigating Annotations</title>
  <style type="text/css">
  </style>
...
<h1>Annotations in the Link window</h1>
...
<h2>See Also:</h2>
<ul>
  <li><span class="Link0"><a href="creating_an_annotation.html.es">Creating an
