...
<table border="0" width="100%" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p align="right"><a href="about_reading_annotations.html.es" accesskey="p"><img
...
("anotaciones locales") o puede almacenarlas <span style="color:blue"><a
href="about_storing_remote_annotations.html.es">remotamente</a></span>,
accediendo a ella a través de la World Wide Web ("anotaciones remotas").</p>
...
en un directorio especial llamado <strong>anotacones</strong>, y sólo pueden
...
anotación</strong>. Una vez enviada, la antoación local se borra puesto que
