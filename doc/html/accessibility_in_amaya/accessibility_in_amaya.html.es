...
<table border="0" width="100%" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p align="right"><a href="../Access.html.es" accesskey="t"><img
...
<p>Ya que Amaya es un proyecto Open Source, es importante que permita
...
<ul>
  <li><span class="Link"><a
    href="about_amayas_accessibility_features.html.es">Acerca de las
    características de accesibilidad de Amaya</a></span></li>
  <li><span class="Link"><a
    href="about_producing_accessible_content.html.es">Crear contenido
    accesible</a></span></li>
</ul>
</div>
</body>
