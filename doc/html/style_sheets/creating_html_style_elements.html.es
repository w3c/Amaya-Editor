...
en la barra de botones: <em>em</em> <img src="../../images/Em.gif"
...
<ol>
  ...
  <li>Elige una opción del submenú <strong>Tipo de Información</strong>.
...
del texto a itálica, negrita, teletipo, superíndice, subíndice y otros (estas
opciones se incluyen para cubrir la recomendación HTML 3.2).</p>
