...
<table border="0" width="100%" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p align="right"><a href="create_table.html.ru" accesskey="p"><img
        alt="Предыдущий" src="../../images/left.gif" /></a> <a
        href="../Tables.html.ru" accesskey="t"><img alt="Вверх"
        src="../../images/up.gif" /></a> <a href="add_row.html.ru"
...
<div id="page_body">
<h1>Добавление новых столбцов в таблицу</h1>

<p class="ProcedureCaption">Для добавления новых столбцов в таблицу:</p>
<ol>
...
используйте кнопки <code>F2</code> на Windows и <code>Esc</code> на Linux),
