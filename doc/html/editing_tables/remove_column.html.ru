...
<table border="0" width="100%" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p align="right"><a href="add_tbody.html.ru" accesskey="p"><img
        alt="Предыдущий" src="../../images/left.gif" /></a> <a
        href="../Tables.html.ru" accesskey="t"><img alt="Вверх"
...
<div id="page_body">
<h1>Удаление/Копирование/Вставка столбца</h1>

<p>Когда выбран весь столбец, его можно удалять, копировать (или вырезать) и
вставлять перед или после любого другого столбца.</p>
...
<ol>
  ...
  <li>Также, вы можете начать выделение начав его в ячейки и расширять его на
    ...
    на кнопку <code>F2</code> на Windows (или кнопку <code>Esc</code> на
    Linux) расширяет выбор в столбце и присоединяет две целых ячейки (Ячейка
    1.2, Ячейка 2.2, Ячейка 3.2).</li>
</ol>
...
<p>Когда выбран весь столбец, его можно копировать (или вырезать) и вставлять
перед или после любого другого столбца.</p>
<ol>
