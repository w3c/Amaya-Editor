...
<table border="0" width="100%" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p align="right"><a href="add_column.html.ru" accesskey="p"><img
        alt="Предыдущий" src="../../images/left.gif" /></a> <a
        href="../Tables.html.ru" accesskey="t"><img alt="Вверх"
        src="../../images/up.gif" /></a> <a href="add_tbody.html.ru"
...
<div id="page_body">
<h1>Добавление новой строки</h1>

<p class="ProcedureCaption">Для создания новой строки:</p>
<ol>
...
<p class="ProcedureCaption">Для удаления или копирования/вставки строки:</p>

<p>Когда выбрана вся строка, её можно удалить, копировать (или вставить) и
вставить её перед или после любой другой строки.</p>
