...
que se encuentran junto con los párrafos y el resto de elementos de
bloque.</p>

<p>Existe también el elemento <code><a
...
pulsa el atajo de teclado <kbd>Ctrl-t, Ctrl-v</kbd> en Unix).</p>
