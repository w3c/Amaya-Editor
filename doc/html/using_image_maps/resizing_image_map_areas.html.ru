...
<table border="0" width="100%" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p align="right"><a href="moving_image_map_areas.html.ru"
        accesskey="p"><img alt="Предыдущий" src="../../images/left.gif"
        /></a> <a href="../ImageMaps.html.ru" accesskey="t"><img alt="Вверх"
        src="../../images/up.gif" /></a> <a
        href="about_alternative_text_and_long_descriptions.html.ru"
...
<div id="page_body">
<h1>Изменение размеров областей изображения карты</h1>

<p>После того как вы <a
href="creating_clientside_image_maps.html.ru">определите область</a> в
пределах изображения карты, вам может понадобиться изменить размер этой
области.</p>

<p class="ProcedureCaption">Для изменения размера области изображения карты
...
<ol>
  ...
  <li>Область изображения карты изменит свой размер в открытом окне
  браузера.</li>
</ol>
</div>
</body>
