...
<table border="0" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p><a href="selecting_with_keyboard_and_mouse.html.es" accesskey="p"><img alt="previous"
        src="../../images/left.gif" /></a> 
		<a href="../Selecting.html.es" accesskey="t"><img alt="top" src="../../images/up.gif" /></a> 
		<a href="selecting_by_structure.html.es" accesskey="n"><img alt="next"
...
<ol>
  <li>Click and drag anywhere within the image, and then release the mouse
    button. Be sure not to drag outside the image before releasing the mouse.
    <p></p>
  </li>
...
<p class="ProcedureNote"><strong>Note:</strong>    When using the arrow keys,
