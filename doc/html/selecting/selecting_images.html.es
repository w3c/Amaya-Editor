...
<table border="0" summary="toc">
  <tbody>
    <tr>
      ...
      <td><p><a href="selecting_with_keyboard_and_mouse.html.es"
...
<p>Para seleccionar una imagen o para mover el cursor a la izquierda o a la
derecha de una imagen, utiliza los procedimientos siguientes:</p>
...
<ol>
  ...
  <li>Utiliza los comandos copiar, cortar y pegar para mover o duplicar el
    elemento imagen junto con todos sus atributos.</li>
</ol>

<p class="ProcedureCaption">Para situar el cursor a la izquierda o derecha de
la imagen:</p>
<ul>
  ...
  <li>Haz clic en la parte derecha de una imagen para situar el cursor en el
    borde derecho de la imagen. Esto te permite escribir texto después de la
    imagen.</li>
</ul>
