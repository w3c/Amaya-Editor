...
<ul>
  ...
  <li>Нажмите кнопку <kbd>F5</kbd> для выбора дочернего элемента.
    <p></p>
  </li>
  <li>Нажмите кнопку <kbd>F3</kbd>  для выбора следующего элемента на том же
    уровне, или на уровне родительского элемента, если нет следующего или
    предыдущего потомка из текущего уровня.
    <p></p>
  </li>
  <li>Нажмите кнопку <kbd>F1</kbd> для выбора предыдущего элемента на том же
    уровне, или на уровне родительского элемента, если нет предыдущего
