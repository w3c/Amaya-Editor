 ...
 * /users/veillard/opera/LINUX-ELF/javalib/../bin/javastub -T JavaTypes.def -M thotlib_APIPresentation -J /users/veillard/opera/classes/thotlib/APIPresentation.java /users/veillard/opera/thotlib/include/presentation.h 
 */
/*
...
/*
 * Java to C function TtaNewPRuleForView stub.
 */
jlong
thotlib_APIPresentation_TtaNewPRuleForView(struct Hthotlib_APIPresentation* none, jint presentationType, jint view, jint document)
{
	jlong result;
	PRule res;
	...
	res = TtaNewPRuleForView((int ) presentationType, (int ) view, (Document ) document);
...
void register_thotlib_APIPresentation_stubs(void)
{
	...
	addNativeMethod("thotlib_APIPresentation_TtaNewPRuleForView", thotlib_APIPresentation_TtaNewPRuleForView);
