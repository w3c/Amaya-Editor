 ...
 * ../solaris2/bin/javastub -T JavaTypes.def -M thotlib_APIPresentation -J ../classes/thotlib/APIPresentation.java ../thotlib/include/presentation.h 
 */
/*
 ...
 */
jint
thotlib_APIPresentation_TtaGetBoxMaxSize(struct Hthotlib_APIPresentation* none, jint element, jint document, jint view, jint unit)
{
	int res;
