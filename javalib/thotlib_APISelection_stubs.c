 ...
 * /users/veillard/opera/LINUX-ELF/javalib/../bin/javastub -T JavaTypes.def -M thotlib_APISelection -J ../classes/thotlib/APISelection.java ../thotlib/include/selection.h 
 */
/*
...
/*
 * Java to C function TtaGetSelectedDocument stub.
 */
jint
thotlib_APISelection_TtaGetSelectedDocument(struct Hthotlib_APISelection* none)
{
	Document res;
...
void register_thotlib_APISelection_stubs(void)
{
	...
	addNativeMethod("thotlib_APISelection_TtaGetSelectedDocument", thotlib_APISelection_TtaGetSelectedDocument);
