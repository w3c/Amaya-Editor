 ...
 * /users/veillard/opera/LINUX-ELF/javalib/../bin/javastub -T JavaTypes.def -M thotlib_APIReference -J ../classes/thotlib/APIReference.java ../thotlib/include/reference.h 
 */
/*
...
/*
 * Java to C function TtaCopyIncludedElem stub.
 */
void
thotlib_APIReference_TtaCopyIncludedElem(struct Hthotlib_APIReference* none, jlong jelement, jint document)
{
	Element element;
	...
	TtaCopyIncludedElem((Element ) element, (Document ) document);
...
void register_thotlib_APIReference_stubs(void)
{
	...
	addNativeMethod("thotlib_APIReference_TtaCopyIncludedElem", thotlib_APIReference_TtaCopyIncludedElem);
