...
################
{
my $base_repertory = "/home/ehuck/xmldoc/";
my $name_of_base = "base_am_msg.xml";
my $base = $base_repertory . $name_of_base ;

my $h_file_repertory = "/home/ehuck/xmldoc/";#"/home/ehuck/opera/Amaya/LINUX-ELF/amaya/";
my $name_of_h_file = "amayamsg.h";#"EDITOR.h";
...
#	create the new base it in order to add at the end and write the begin of the new base 
	init_the_base ($base ) ;	# create $base.NEW
...
#	Create the new base and close it (to erase an a hipotetic already existing file )
	open ( OUT, ">".$_[0] . ".new") || die "can't create " . $_[0] . ".new because: $! \n";
	close ( OUT) || die "can't close ".$_[0].".new because: $! \n";
	
	open ( OUT , ">>" . $_[0] . ".new" ) || die "can't open for adds in " . $_[0] . "because: $! \n";
