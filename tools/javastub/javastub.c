...
void dump_cmd(FILE *out) {
    ...
    fprintf(out," *\n * Generated by the following command from %s directory\n * ",
            pwd);
...
void dump_java(FILE *out) {
    ...
    fprintf(out,"/*\n * Java public native definitions for class %s\n",
           classname);
    fprintf(out," * This piece of code has to be copied in the Java code\n");
    fprintf(out," * for class %s i.e %s.java\n",
           classname, classname);
    dump_cmd(out);
    fprintf(out," */\n\n");
    for (i = 0;i < nbFunctions;i++) {
