...
static void         WriteIncludes (char *fname, FILE * file)
{
  ...
  if (!strcmp (fname, "EDITOR"))
  {
    fprintf (file, "#ifdef _WX\n");
    fprintf (file, "#include \"wx/wx.h\"\n");
    fprintf (file, "#endif /* _WX */\n");
  }
...
static void         WriteActionList (char *fname)
{
  ...
  if (!strcmp (fname, "EDITOR"))
      ...
      while (menuAction != NULL)
	{
      ...
      fprintf (AppFile, "#ifdef _WX\n");
      fprintf (AppFile, "  /* extract the name of the application */\n");
      fprintf (AppFile, "  wxString wx_appname((wxChar *)argv[0]);\n");
      fprintf (AppFile, "  char appname[512];\n");
      fprintf (AppFile, "  strcpy(appname, (const char *)wx_appname.mb_str(wxConvUTF8));\n");
      fprintf (AppFile, "  if (strstr (appname, \"amaya\"))\n");
      fprintf (AppFile, "    {\n");
      fprintf (AppFile, "      strcpy (appName, \"amaya\");\n");
      fprintf (AppFile, "      strcpy (workName, \"amaya\");\n");
      fprintf (AppFile, "    }\n");
      fprintf (AppFile, "  else\n");
      fprintf (AppFile, "    TtaExtractName ((char *)appname, workName, appName);\n");
      fprintf (AppFile, "#else /* _WX */\n");
      fprintf (AppFile, "  /* extract the name of the application */\n");
