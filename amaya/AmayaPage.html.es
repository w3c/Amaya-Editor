...
<p><svg xmlns="http://www.w3.org/2000/svg" width="600" height="349">
  ...
  <g style="fill:#dc5b53; font: bold 16px" transform="translate(477,0)">
    ...
    <a xlink:href="../doc/html/Manual.html.es">
      <text y="68px" x="0px">Manual
      </text>
    </a>
    <a xlink:href="../doc/html/Index.html.es">
      <text y="98px" x="0px">Índice
      </text>
    </a>
    <a xlink:href="../doc/html/Annotations.html.es">
      <text y="128px" x="0px">Anotaciones
      </text>
    </a>
    <a xlink:href="../doc/html/Creating.html.es">
      <text y="158px" x="0px">XHTML
      </text>
    </a>
    <a xlink:href="../doc/html/Math.html.es">
      <text y="188px" x="0px">MathML
      </text>
    </a>
    <a xlink:href="../doc/html/SVG.html.es">
      <text y="218px" x="0px">SVG
      </text>
    </a>
    <a xlink:href="../doc/html/StyleSheets.html.es">
  ...
  <g>
    <image id="backgroundImage" xlink:href="amaya.png" width="471px"
           height="338px" y="1px">
