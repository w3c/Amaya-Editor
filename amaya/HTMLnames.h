...
static ElemMapping    XHTMLElemMappingTable[] =
{
   ...
   {"DOCTYPE_line", SPACE, HTML_EL_DOCTYPE_line, L_BasicValue, FALSE},
   ...
   {"applet", SPACE, HTML_EL_Applet, L_TransitionalValue, FALSE},
   ...
   {"embed",  'E', HTML_EL_Embed, L_TransitionalValue, TRUE},
   ...
   {"iframe", SPACE, HTML_EL_IFRAME, L_TransitionalValue, FALSE},
   ...
   {"input", 'E', HTML_EL_Checkbox_Input, L_BasicValue, FALSE},
   {"input", 'E', HTML_EL_Radio_Input, L_BasicValue, FALSE},
   {"input", 'E', HTML_EL_Submit_Input, L_BasicValue, FALSE},
   {"input", 'E', HTML_EL_Reset_Input, L_BasicValue, FALSE},
   {"input", 'E', HTML_EL_Button_Input, L_BasicValue, TRUE},
   {"input", 'E', HTML_EL_Hidden_Input, L_BasicValue, FALSE},
   ...
   {"table", SPACE, HTML_EL_Table, L_BasicValue, FALSE},
