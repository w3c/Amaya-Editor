...
AttributeMapping XHTMLAttributeMappingTable[] =
{
   ...
   {"char", "", 'A', HTML_ATTR_char, L_Strict},
   ...
   {"for", "label", 'A', HTML_ATTR_Associated_control, L_Basic},
   ...
   {"headers", "", 'A', HTML_ATTR_headers, L_Basic},
   ...
   {"size", "input", 'A', HTML_ATTR_Area_Size, L_Basic},
   {"size", "select", 'A', HTML_ATTR_MenuSize, L_Basic},
