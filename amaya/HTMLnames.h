...
static ElemMapping    XHTMLElemMappingTable[] =
{
   ...
   {TEXT("area"), 'E', HTML_EL_AREA, L_Strict},
   ...
   {TEXT("bdo"), SPACE, HTML_EL_BDO, L_Strict},
   ...
   {TEXT("fieldset"), SPACE, HTML_EL_FIELDSET, L_Strict},
   ...
   {TEXT("hr"), 'E', HTML_EL_Horizontal_Rule, L_Strict},
   {TEXT("html"), SPACE, HTML_EL_HTML, L_Basic},
   {TEXT("i"), SPACE, HTML_EL_Italic_text, L_Strict},
   {TEXT("iframe"), SPACE, HTML_EL_IFRAME, L_Transitional},
   {TEXT("image"), 'E', HTML_EL_PICTURE_UNIT, L_Strict},
   {TEXT("img"), 'E', HTML_EL_PICTURE_UNIT, L_Basic},
   {TEXT("input"), 'E', HTML_EL_Input, L_Basic},
   {TEXT("ins"), SPACE, HTML_EL_INS, L_Strict},
   ...
   {TEXT("legend"), SPACE, HTML_EL_LEGEND, L_Strict},
   ...
   {TEXT("map"), SPACE, HTML_EL_MAP, L_Strict},
   ...
   {TEXT("s"), SPACE, HTML_EL_Struck_text, L_Strict},
   {TEXT("samp"), SPACE, HTML_EL_Sample, L_Basic},
   {TEXT("script"), SPACE, HTML_EL_SCRIPT, L_Strict},
   {TEXT("select"), SPACE, HTML_EL_Option_Menu, L_Basic},
   {TEXT("small"), SPACE, HTML_EL_Small_text, L_Strict},
   ...
   {TEXT("style"), SPACE, HTML_EL_STYLE_, L_Strict},
   {TEXT("sub"), SPACE, HTML_EL_Subscript, L_Strict},
   {TEXT("sup"), SPACE, HTML_EL_Superscript, L_Strict},
   ...
   {TEXT("tfoot"), SPACE, HTML_EL_tfoot, L_Strict},
   {TEXT("th"), SPACE, HTML_EL_Heading_cell, L_Basic},
   {TEXT("thead"), SPACE, HTML_EL_thead, L_Strict},
   {TEXT("title"), SPACE, HTML_EL_TITLE, L_Basic},
   {TEXT("tr"), SPACE, HTML_EL_Table_row, L_Basic},
   {TEXT("tt"), SPACE, HTML_EL_Teletype_text, L_Strict},
   {TEXT("u"), SPACE, HTML_EL_Underlined_text, L_Strict},
