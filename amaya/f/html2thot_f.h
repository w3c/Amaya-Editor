...
extern void MapHTMLAttribute ( char *Attr, AttributeType *attrType, char* elementName );
...
extern void OnlyOneOptionSelected ( Element el, Document doc, boolean parsing );
extern void SetAttrIntItemStyle ( Element el, Document doc );
extern void CreateAttrWidthPercentPxl ( char *buffer, Element el, Document doc, int oldWidth );
...
extern void ParseIncludedHTML ( Element elem, char *closingTag );
extern void ParseSubTree ( char *HTMLbuf, Element lastelem, boolean isclosed, Document doc );
extern void StartHTMLParser ( Document doc, char *htmlFileName, char *documentName, char *documentDirectory, char *pathURL, boolean PlainText );
