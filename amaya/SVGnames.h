...
static AttributeMapping SVGAttributeMappingTable[] =
{
   ...
   {"display", "", 'A', SVG_ATTR_display, L_OtherValue},
   ...
   {"filter", "", 'A', SVG_ATTR_filter, L_OtherValue},
   ...
   {"offset", "", 'A', SVG_ATTR_offset, L_OtherValue},
   ...
   {"shape_rendering", "", 'A', SVG_ATTR_shape_rendering, L_OtherValue},
   {"slope", "", 'A', SVG_ATTR_slope, L_OtherValue},
...
{ 
   ...
   {SVG_ATTR_display, "block", SVG_ATTR_display_VAL_block},
   {SVG_ATTR_display, "compact", SVG_ATTR_display_VAL_compact},
   {SVG_ATTR_display, "inherit", SVG_ATTR_display_VAL_inherit},
   {SVG_ATTR_display, "inline", SVG_ATTR_display_VAL_inline},
   {SVG_ATTR_display, "inline-table", SVG_ATTR_display_VAL_inline_table},
   {SVG_ATTR_display, "list-item", SVG_ATTR_display_VAL_list_item},
   {SVG_ATTR_display, "marker", SVG_ATTR_display_VAL_marker_},
   {SVG_ATTR_display, "none", SVG_ATTR_display_VAL_none},
   {SVG_ATTR_display, "run-in", SVG_ATTR_display_VAL_run_in},
   {SVG_ATTR_display, "table", SVG_ATTR_display_VAL_table},
   {SVG_ATTR_display, "table-caption", SVG_ATTR_display_VAL_table_caption},
   {SVG_ATTR_display, "table-cell", SVG_ATTR_display_VAL_table_cell},
   {SVG_ATTR_display, "table-column", SVG_ATTR_display_VAL_table_column},
   {SVG_ATTR_display, "table-column-group", SVG_ATTR_display_VAL_table_column_group},
   {SVG_ATTR_display, "table-footer-group", SVG_ATTR_display_VAL_table_footer_group},
   {SVG_ATTR_display, "table-header-group", SVG_ATTR_display_VAL_table_header_group},
   {SVG_ATTR_display, "table-row", SVG_ATTR_display_VAL_table_row},
   {SVG_ATTR_display, "table-row-group", SVG_ATTR_display_VAL_table_row_group},
