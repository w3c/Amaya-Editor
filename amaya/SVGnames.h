...
static ElemMapping    SVGElemMappingTable[] =
{
   ...
   {"set", SPACE, SVG_EL_set, L_OtherValue, FALSE},
...
static AttributeMapping SVGAttributeMappingTable[] =
{
   ...
   {"attributeName", "", 'A', SVG_ATTR_attributeName, L_OtherValue},
   ...
   {"max", "", 'A', SVG_ATTR_max, L_OtherValue},
   {"media", "", 'A', SVG_ATTR_media, L_OtherValue},
   {"min", "", 'A', SVG_ATTR_min, L_OtherValue},
...
{ 
   ...
   {SVG_ATTR_fill_, "remove", SVG_ATTR_fill__VAL_remove},
