...
<head>
  ...
  <meta name="generator" content="amaya 9.2, see http://www.w3.org/Amaya/" />
...
<h1>Добро пожаловать в Amaya 9.2</h1>
...
пользователям в создании правильных веб страниц.<br />
...
<p class="bottom">Разрешение на использование, копирование, изменение и
распространение этого программного обеспечения и его документации для любых
