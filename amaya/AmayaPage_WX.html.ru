...
<h1>Добро пожаловать в Amaya 9.0</h1>

<p>Amaya является веб клиентом и может использоваться и как браузер и как
инструмент авторского редактирования. Он создан <a onclick="" href="http://www.w3.org/">W3C</a>
и <a onclick="" href="http://www.inria.fr/">INRIA</a> главной целью которых является
демонстрация новых веб технологий и помощь пользователям в создании правильных веб страниц.<br />
С помощью Amaya, вы можете работать со сложными веб страницами, таблицами, и
большинством дополнительных возможностей, предоставляемых <acronym
title="Hypertext Markup Language">XHTML</acronym>. Вы можете создавать и редактировать
сложные <a href="../doc/html/Math.html">математические выражения</a> в
веб страницах. Используя каскадные таблицы стилей, вы можете стильно оформлять свои документы.</p>
...
<dl>
  <dt>Amaya является редактором структуры</dt>
    <dd>С помощью кнопки F2 вы можете выбирать вложенные структуры, а функции
      редактирования (копировать, вставить, атрибуты, и прочее.) могут применяться к этим
      самым элементам структуры.</dd>
  <dt>Документ может редактироваться через синхронизируемые виды</dt>
    <dd>Из меню Вид можно открывать вид Структура, вид Исходный код и прочее.
      Щелчок по основанию красной линии открывает или закрывает второй вид.</dd>
  <dt>Документ может публиковаться непосредственно на сервере</dt>
    <dd>С http методом PUT вы можете записывать прямо на сервер, в соответствии с вашими правами доступа.</dd>
  <dt>Ссылки могут создаваться простым щелчком</dt>
    <dd>Для создания ссылки вы можете щёлкнуть прямо на цели (используя для показа доступных целей
      пункт меню Показать цель).</dd>
...
<p class="bottom">Разрешение на использование, копирование, изменение и распространение
этого программного обеспечения и его документации для любых целей без оплаты и любых других лицензионных платежей,
может быть получено при условии что полный текст <a
href="http://www.w3.org/Consortium/Legal/copyright-software.html"><acronym
title="Massachusetts Institute of Technology">MIT</acronym> и права собствености INRIA
</a> будут находиться во <strong>всех</strong> копиях этого программного обеспечения и документации
или части всего этого, включая изменения которые вы сделаете.</p>
