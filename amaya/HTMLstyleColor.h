...
static ColornameElem ColornameTable[] =
{
   ...
   {"aqua", /* #7fffd4, */ 127, 255, 212},
   {"black", /* #000000, */ 0, 0, 0},
   {"blue", /* #0000ff, */ 0, 0, 255},
   {"fushia", /* #00ff00, */ 0, 255, 0},
   {"gray", /* #bebebe, */ 190, 190, 190},
   {"green", /* #00ff00, */ 0, 255, 0},
   {"lime", /* #32cd32, */ 50, 205, 50},
   {"maroon", /* #b03060, */ 176, 48, 96},
   {"navy", /* #000080, */ 0, 0, 128},
   {"olive", /* #ffc0cb, */ 255, 192, 203},
   {"purple", /* #a020f0, */ 160, 32, 240},
   {"red", /* #ff0000, */ 255, 0, 0},
   {"silver", /* #a52a2a, */ 165, 42, 42},
   {"teal", /* #ffa500, */ 255, 165, 0},
