   ...
   if (DocumentTypes[doc] == docHTML || DocumentTypes[doc] == docAnnot)
	...
	TtaSetAttributeText (attr, buffer, root, doc);
       ...
       if (useMathML && DocumentMeta[doc]->xmlformat)
	 {
	   ...
	   TtaAttachAttribute (root, attr, doc);
	   strcat (buffer,
		   "<!-- Processing Instruction automatically generated by Amaya; the mathml xsl stylesheet is available on the W3C site at : http://www.w3.org/Math/XSL/pmathml.xsl -->\n");	   
	   strcat (buffer,
		   "<?xml-stylesheet type=\"text/xsl\" href=\"pmathmlxsl.xml\"?>\n");
	   TtaSetAttributeText (attr, buffer, root, doc);
	 }
       }
     }
	   ...
	   if (useMathML && DocumentMeta[doc]->xmlformat)
	     {
	       ...
	       TtaAttachAttribute (root, attr, doc);
	       strcat (buffer,
		       "<!-- Processing Instruction automatically generated by Amaya; the mathml xsl stylesheet is available on the W3C site at http://www.w3.org/Math/Group/XSL/ -->\n");	   
	       strcat (buffer,
		       "<?xml-stylesheet type=\"text/xsl\" href=\"");
	       strcat (buffer, MATHML_XSLT_URI);
